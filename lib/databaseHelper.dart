...
//   Future<List<Word>> queryWord(int id) async {
//     Database db = await database;
...
//     /// getting all the list from that cetain table...............
//     List<Map<String, dynamic>> map = await db.query(tableWords);
//     print(">>>>>>>>>>\n");
//     print(map);
//     List<Word> wordList;

//     wordList = List.generate(map.length, (i) {
//       return Word.fromMap(map[i]);
//     });
